...
public class AppUtils {
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(YUtils.getContext()), true);
    ...
    public static void launchApp(String packageName) {
        if (isSpace(packageName)) return;
        YUtils.getContext().startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
